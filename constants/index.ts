...
export const experiencesData = [
  {
    ...
    description: "Pursuing bachelor's degree in CE engineering.",
...

  {
    ...
    location: "Openxcell | Next-Gen AI Services",
    description:
      "Working as a Associate Software Developer in Openxcell | Next-Gen AI Services and working with  Next.js , Typescript , Tailwind and GitHub. Along with Learning AI , AI workflows , cloud computing, prompting and many more.",
